<div id="data_b__masuk" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="m-5 pb-10">
                <h2 class="mb-2 text-lg font-semibold text-gray-900 dark:text-white">Barang Masuk:</h2>
                <ul class="max-w-md space-y-1 text-gray-500 list-decimal list-inside dark:text-gray-400">
                    @foreach ($stock as $s)
                        @if ($s->status == 'pending' && $s->type == 'masuk')
                            <li>
